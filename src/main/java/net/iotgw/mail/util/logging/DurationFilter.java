 ...
 * <pre>
 * {@code
 *  net.iotgw.mail.util.logging.MailHandler.filter = net.iotgw.mail.util.logging.DurationFilter
 *  net.iotgw.mail.util.logging.MailHandler.capacity = 1000
 *  net.iotgw.mail.util.logging.DurationFilter.records = 2L * 1000L
 *  net.iotgw.mail.util.logging.DurationFilter.duration = PT6M
 * }
 * </pre>
 *
 *
