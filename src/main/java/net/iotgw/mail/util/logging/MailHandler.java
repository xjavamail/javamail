 ...
 *      net.iotgw.mail.util.logging.MailHandler.mail.smtp.host = my-mail-server
 *      net.iotgw.mail.util.logging.MailHandler.mail.to = me@example.com
 *      net.iotgw.mail.util.logging.MailHandler.level = WARNING
 *      net.iotgw.mail.util.logging.MailHandler.verify = local
 * </pre>
 *
 ...
 * net.iotgw.mail.util.logging.CollectorFormatter CollectorFormatter}.)
 *
   ...
   /**
    ...
    private void initSubject(final String p) {
        ...
        if (name == null) { //Soft dependency on CollectorFormatter.
            name = "net.iotgw.mail.util.logging.CollectorFormatter";
        }
