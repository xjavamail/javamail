...
import net.iotgw.mail.imap.protocol.*;
import net.iotgw.mail.util.CRLFOutputStream;
 ...
 * for more information. <p>
 *
 * The {@link #open(int,net.iotgw.mail.imap.ResyncData) open(int,ResyncData)}
 * method and {@link net.iotgw.mail.imap.ResyncData ResyncData} class supports
 ...
 *
 * See the <a href="package-summary.html">net.iotgw.mail.imap</a> package
...
public class IMAPFolder extends Folder implements UIDFolder, ResponseHandler {
	...
	*/
     ...
     * of the <code>net.iotgw.mail.iap</code> and
     * <code>net.iotgw.mail.imap.protocol</code> packages, best acquired by
     * reading the source code.
     *
     * <blockquote><pre>
     * import net.iotgw.mail.iap.*;
     * import net.iotgw.mail.imap.*;
     * import net.iotgw.mail.imap.protocol.*;
     *
     * ...
     *
