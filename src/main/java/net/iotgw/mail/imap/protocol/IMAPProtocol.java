...
import net.iotgw.mail.imap.ACL;
import net.iotgw.mail.imap.AppendUID;
import net.iotgw.mail.imap.CopyUID;
import net.iotgw.mail.imap.ResyncData;
import net.iotgw.mail.imap.Rights;
import net.iotgw.mail.imap.SortTerm;
import net.iotgw.mail.imap.Utility;
...
public class IMAPProtocol extends Protocol {
	...
	if (saslAuthenticator == null) {
		...
		Class<?> sac = Class.forName(
		    "net.iotgw.mail.imap.protocol.IMAPSaslAuthenticator");
