...
import net.iotgw.mail.auth.Ntlm;
...
import net.iotgw.mail.util.SocketConnectException;
import net.iotgw.mail.util.SocketFetcher;
import net.iotgw.mail.util.TraceInputStream;
import net.iotgw.mail.util.TraceOutputStream;
 ...
 *
 * See the <a href="package-summary.html">net.iotgw.mail.smtp</a> package
...
public class SMTPTransport extends Transport {
	...
	if (saslAuthenticator == null) {
		...
		Class<?> sac = Class.forName(
		    "net.iotgw.mail.smtp.SMTPSaslAuthenticator");
